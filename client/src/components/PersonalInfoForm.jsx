import { BriefcaseBusiness, Github, Linkedin, Mail, MapPin, Phone, User } from 'lucide-react'
            ...
            {typeof data.image === 'object' && (
                <div className='flex flex-col gap-1 pl-4 text-sm'>
                    ...
                    <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                        ...
                        <div className='w-10 h-6 bg-slate-200 rounded-full transition-colors duration-200 peer-checked:bg-green-600'>
                        </div>
