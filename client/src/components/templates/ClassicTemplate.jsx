        ...
        <div className="max-w-4xl mx-auto p-6 bg-white text-gray-800 leading-relaxed">
            ...
            {data.professional_summary && (
                <section className="mb-6" aria-labelledby="summary-heading">
                    <h2 id="summary-heading" className="text-xl font-semibold mb-3" style={{ color: accentColor }}>
                        PROFESSIONAL SUMMARY
                    </h2>
            ...
            {data.experience && data.experience.length > 0 && (
                <section className="mb-6" aria-labelledby="experience-heading">
                    <h2 id="experience-heading" className="text-xl font-semibold mb-4" style={{ color: accentColor }}>
            ...
            {data.project && data.project.length > 0 && (
                <section className="mb-6" aria-labelledby="projects-heading">
                    <h2 id="projects-heading" className="text-xl font-semibold mb-4" style={{ color: accentColor }}>
                        KEY PROJECTS
                    </h2>
            ...
            {data.education && data.education.length > 0 && (
                <section className="mb-6" aria-labelledby="education-heading">
                    <h2 id="education-heading" className="text-xl font-semibold mb-4" style={{ color: accentColor }}>
                        EDUCATION
                    </h2>
                        ...
                        {data.education.map((edu, index) => (
                            <div key={index} className="flex justify-between items-start">
                                ...
                                <div className="text-sm text-gray-600">
                                    <p aria-label={`Graduated in ${formatDateForAria(edu.graduation_date)}`}>
            ...
            {data.skills && data.skills.length > 0 && (
                <section className="mb-6" aria-labelledby="skills-heading">
                    <h2 id="skills-heading" className="text-xl font-semibold mb-4" style={{ color: accentColor }}>
                        CORE SKILLS
                    </h2>
